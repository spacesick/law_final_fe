<template>
  <div>
    <div class="grid grid-cols-3 mt-12">
      <img :src="carImage" class="hidden col-span-3 md:col-span-2 justify-self-center self-center sm:flex md:w-9/12 lg:w-10/12">
...
import carImage from '~/static/car-cropped.png'
